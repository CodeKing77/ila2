...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    try {
        ...
        // CORRECTION: Structure de réponse cohérente avec data.ouvrage
...
try {
    ...
    foreach ($ouvrages as $ouvrage) {
        // CORRECTION: Structurer correctement les données de catégorie
        $formatted_ouvrages[] = [
            'id' => (int)$ouvrage['id'],
            'titre' => $ouvrage['titre'],
            ...
            'auteur' => $ouvrage['auteur_nom'] ?? 'Auteur inconnu',
    ...
    // CORRECTION: Structure de réponse cohérente - retour direct des données
    $response = [
        'success' => true,
